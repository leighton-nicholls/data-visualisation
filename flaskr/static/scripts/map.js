...
queue()
	.defer(d3.csv, "/static/scripts/usa-data.csv")
	...
	countyShapes
		.on("mouseover", function (d) {
			...
			tooltip.html(
				...
				"<table><tbody><tr><td class='wide'>Data in 1996:</td><td>" + formatPercent((d.properties.years[1996][0].rate) / 100) + "</td></tr>" +
				"<tr><td>Data in 2012:</td><td>" + formatPercent((d.properties.years[2012][0].rate) / 100) + "</td></tr>" +
