...
import {
  generateExecutionTotalsByStateBarChartData,
  generateCountyTotalsBarChartData,
  generateLatestExecutionsByStateBarChartData
} from "../../generation/execution/bar-charts";
...
class ExecutionsOverall extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      currentModal: null,
  ...
  componentDidMount = () => {
    generateExecutionTotalsByStateBarChartData(this.props.executions);
    generateCountyTotalsBarChartData(this.props.executions);
    generateLatestExecutionsByStateBarChartData(this.props.executions);
  };
    ...
    return (
      <React.Fragment>
        ...
        <Grid.Row>
          ...
          <Grid.Column width={3}>
            <Header size="medium">
              ...
              {this.props.firstExecutionSummary.firstExecutionByFiringSquadDate}
            </Header>
          </Grid.Column>
          <Grid.Column width={3}>
            <Header size="medium">
        ...
        <Grid.Row>
          ...
          <Grid.Column width={2}>
            <Header size="medium">
              ...
              {
                this.props.mostExecutions
                  .mostExecutionsInSingleYearByLethalInjection.year
              }
              )
            </Header>
          </Grid.Column>
          ...
          <Grid.Column width={3}>
            <Header size="medium">
              ...
              {
                this.props.mostExecutions
                  .mostExecutionsInSingleYearByElectrocution.year
              }
              )
            </Header>
          </Grid.Column>
          <Grid.Column width={3}>
            <Header size="medium">
              ...
              {
                this.props.mostExecutions
                  .mostExecutionsInSingleYearByFiringSquad.year
              }
              )
            </Header>
          </Grid.Column>
        ...
        <Grid.Row>
          <Grid.Column width={3}>
            <Header size="medium">
              Most Executions in a single year by a sole state:{" "}
              {
                this.props.mostExecutions
              ...
              {
                this.props.mostExecutions
                  .mostExecutionsOnSingleYearBySingleState.state
              }
              ,{" "}
              {
                this.props.mostExecutions
          ...
          <Grid.Column width={3}>
            <Header size="medium">
              Most executions on a single day (all states):{" "}
              {
              ...
              {this.props.mostExecutions.mostExecutionsByAllStateBySingleDay.states.map(
                (state, index) => {
                  return (index ? ", " : "") + state;
                }
              )}
          ...
          <Grid.Column width={3}>
            <Header size="medium">
              Most executions in single month (all states):{" "}
              {
              ...
              {this.props.mostExecutions.mostExecutionsByAllStateBySingleMonth.states.map(
                (state, index) => {
          ...
          <Grid.Column width={3}>
            <Header size="medium">
              Most executions in a single month by a sole state:{" "}
              {
                this.props.mostExecutions
              ...
              {
                this.props.mostExecutions
                  .mostExecutionsOnSingleMonthBySingleState.state
              }
              ,{" "}
              {
                this.props.mostExecutions
        ...
        <Grid.Row>
          <Grid.Column width={16}>
            <Header size="medium">
              Most executions in a month grouped by a single day (all states):{" "}
              {getDayOfWeek(
                this.props.mostExecutions.mostExecutionsGroupedByDayByAllStates
                  .day
              )}
              ,{" "}
              {
              ...
              . [
              {this.props.mostExecutions.mostExecutionsGroupedByDayByAllStates.states.map(
                (state, index) => {
                  return `${index ? ", " : ""}${state.state}: ${
                    state.occurences
                  }`;
                      ...
                      return (
                        <React.Fragment key={index}>
                          {`${index ? ". " : ""} ${offender.first_name} ${
                            offender.last_name
                          }, ${offender.state}, ${moment(
                            offender.execution_date
                          ).format("DD/MM/YYYY")}, Total Victim Count: ${
        ...
        <Grid.Row>
          <Grid.Column width={16}>
            <Header size="medium">Executions over time by state</Header>
          </Grid.Column>
        </Grid.Row>
        <Grid.Row>
          <Grid.Column width={16}>
            <LineChart
              data={this.props.executionsOverTimeByStateLineChartData}
              tooltipHtml={tooltipLine}
              tooltipContained
              width={1000}
              height={800}
        ...
        <Grid.Row>
          <Grid.Column width={16}>
            <svg
              id="executionTotalsByStateBarChart"
              width="1050"
              height="500"
            ></svg>
          </Grid.Column>
        ...
        <Grid.Row>
          <Grid.Column width={16}>
            <Header size="medium">States conducting executions by year</Header>
          </Grid.Column>
        </Grid.Row>
        ...
        <Grid.Row>
          <Grid.Column width={16}>
            <LineChart
              data={this.props.numberOfStatesWithExecutionsByYearLineChartData}
              tooltipHtml={tooltipLine}
              tooltipContained
              width={1000}
              height={800}
        ...
        <Grid.Column width={16}>
          <Header size="medium">Latest Executions by state</Header>
        </Grid.Column>

        <Grid.Row>
          <Grid.Column width={16}>
            <svg
              id="latestExecutionsByStateBarChart"
              width="1050"
              height="500"
            ></svg>
          </Grid.Column>
        ...
        <Grid.Row>
          <Grid.Column width={8}>
            <Header size="medium">
              ...
              {this.props.mostExecutions.female.firstFemaleExecuted !=
                undefined && this.renderFirstFemaleExecuted()}
            </Header>
          </Grid.Column>
          ...
          <Grid.Column width={8}>
            <Header size="medium">
              ...
              {this.props.mostExecutions.female.latestFemaleExecuted !=
                undefined && this.renderLatestFemaleExecuted()}
            </Header>
          </Grid.Column>
        ...
        {/*} <Grid.Row>
            <Grid.Column width={16}>
              <LineChart
                data={this.props.victimLineChartData}
                tooltipHtml={tooltipLine}
                tooltipContained
                width={1000}
                height={800}
        ...
        <Grid.Row>
          <Grid.Column width={16}>
            <Header size="medium">Region breakdown</Header>
          </Grid.Column>
        </Grid.Row>
        <Grid.Row>
          <Grid.Column width={16}>
            <PieChart
              data={this.props.regionBreakdownPieChartData}
              tooltipOffset={{ top: 175, left: 200 }}
              tooltipHtml={tooltipPie}
              tooltipMode={"fixed"}
              width={1000}
        ...
        <Grid.Row>
          <Grid.Column width={16}>
            <LineChart
              data={this.props.regionBreakdownLineChartData}
              tooltipHtml={tooltipLine}
              tooltipContained
              width={1000}
              height={800}
      ...
      <React.Fragment>
        <Grid divided="vertically">
          ...
          {this.props.executions.length > 0 &&
            this.renderMainExecutionContent()}
        </Grid>
...
export default ExecutionsOverall;
