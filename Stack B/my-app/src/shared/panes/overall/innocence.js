...
import {
  generateInnocenceExonerationsByStateBarChartData,
  generateReasonBreakdownsByStateBarChartData
} from "../../../shared/generation/innocence/bar-charts";
...
class InnocenceOverall extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      currentModal: null,
  ...
  componentDidUpdate(prevProps) {
    if (this.props.innocents !== prevProps.innocents) {
      generateInnocenceExonerationsByStateBarChartData(this.props.innocents);
              ...
              (innocent, index) => {
                return (
                  <React.Fragment key={index}>
                    {innocent.name}, {innocent.state}, {innocent.convicted} to{" "}
    ...
    return (
      <React.Fragment>
        ...
        <Grid.Row>
          <Grid.Column width={16}>
            <Header size="medium">
              Overall number of states having innocents by year (exonerations)
            </Header>
          </Grid.Column>
        </Grid.Row>
        ...
        <Grid.Row>
          <Grid.Column width={16}>
            <LineChart
              data={this.props.statesHavingInnocentsByYearOverallLineChartData}
              tooltipHtml={tooltipLine}
              tooltipContained
              width={1000}
              height={800}
        ...
        <Grid.Row>
          <Grid.Column width={16}>
            <Header size="medium">Convictions over time by state</Header>
          </Grid.Column>
        </Grid.Row>
        ...
        <Grid.Row>
          <Grid.Column width={16}>
            <LineChart
              data={this.props.innocenceConvictionsByStateLineChartData}
              tooltipHtml={tooltipLine}
              tooltipContained
              width={1000}
              height={800}
        ...
        <Grid.Row>
          <Grid.Column width={16}>
            <Header size="medium">
              Exonerations (inc. convictions) overall by state
            </Header>
          </Grid.Column>
        </Grid.Row>
        ...
        <Grid.Row>
          <Grid.Column width={16}>
            <svg
              id="innocenceExonerationsByStateBarChartData"
              width="1050"
              height="500"
            ></svg>
          </Grid.Column>
        ...
        <Grid.Row>
          <Grid.Column width={16}>
            <Header size="medium">Exonerations over time by state</Header>
          </Grid.Column>
        </Grid.Row>
        ...
        <Grid.Row>
          <Grid.Column width={16}>
            <LineChart
              data={this.props.innocenceExonerationsByStateLineChartData}
              tooltipHtml={tooltipLine}
              tooltipContained
              width={1000}
              height={800}
    ...
    return (
      <React.Fragment>
        <Grid divided="vertically">
          ...
          {this.props.innocents.length > 0 && this.renderMainInnocenceContent()}
...
export default InnocenceOverall;
