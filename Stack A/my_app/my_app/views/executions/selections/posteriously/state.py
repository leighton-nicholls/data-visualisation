...
@app.route('/getTotalExecutionsOnStateLevelByYearPosteriously', methods=['GET'])
def getTotalExecutionsOnStateLevelByYearPosteriously():
...
@app.route('/getExecutionsMethodsOnStateLevelByYearPosteriously/<year>', methods=['GET'])
def getExecutionsMethodsOnStateLevelByYearPosteriously(year=None):
    pipeline = [
...
@app.route('/getExecutionMethodsSummaryOnStateLevelByYearPosteriously/<year>', methods=['GET'])
def getExecutionMethodsSummaryOnStateLevelByYearPosteriously(year=None):
    pipeline = [
