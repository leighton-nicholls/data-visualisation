...
@app.route('/getTotalExecutionsOnStateLevelByYearNonPosteriously/<year>', methods=['GET'])
def getTotalExecutionsOnStateLevelByYearNonPosteriously(year=None):
    year = int(year)
...
@app.route('/getExecutionsMethodsOnStateLevelByYearNonPosteriously/<year>', methods=['GET'])
def getExecutionsMethodsOnStateLevelByYearNonPosteriously(year=None):
    year = int(year)
    today = datetime.today() # or datetime.now to use local timezone
    currentYear = datetime.now().year
...
@app.route('/getExecutionMethodsSummaryOnStateLevelByYearNonPosteriously/<year>', methods=['GET'])
def getExecutionMethodsSummaryOnStateLevelByYearNonPosteriously(year=None):
    year = int(year)
    today = datetime.today() # or datetime.now to use local timezone
    currentYear = datetime.now().year
