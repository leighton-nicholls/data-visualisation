...
@app.route('/getTotalExecutionsOnMilitaryLevelByYearNonPosteriously/<year>', methods=['GET'])
def getTotalExecutionsOnMilitaryLevelByYearNonPosteriously(year=None):
    year = int(year)
...
@app.route('/getExecutionsMethodsOnMilitaryLevelByYearNonPosteriously/<year>', methods=['GET'])
def getExecutionsMethodsOnMilitaryLevelByYearNonPosteriously(year=None):
    year = int(year)
    today = datetime.today() # or datetime.now to use local timezone
    currentYear = datetime.now().year
...
@app.route('/getExecutionMethodsSummaryOnMilitaryLevelByYearNonPosteriously/<year>', methods=['GET'])
def getExecutionMethodsSummaryOnMilitaryLevelByYearNonPosteriously(year=None):
    year = int(year)
    today = datetime.today() # or datetime.now to use local timezone
    currentYear = datetime.now().year
